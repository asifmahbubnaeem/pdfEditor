...
console.log("sdfdfs df");
  ...
  formData.append("deletedPage", deleted_page_numbers);
  formData.append("rotationInfo", JSON.stringify(rotationInfo));
  

  try{
    const response = await fetch(`${API_URL}/api/page-del-rotation`, {
      method: "POST",
      body: formData,
    });
    ...
    if (!response.ok){
       ...
       throw new Error("Rearrange/delete Action failed");
     }
