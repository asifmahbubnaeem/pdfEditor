...
function SortablePage({ id, pageNumber, onDelete, onEnlarge }) {
  ...
  return (
    <div
      ...
      {...attributes}
      {...listeners}
      className="group relative border rounded-lg shadow bg-white p-2"
    >
      {/* Thumbnail */}
      <Page
        ...
        onMouseEnter={()=>console.log("clicked on ", {pageNumber})}
      />
    ...
    <PageLayout>
      ...
      <div className="flex flex-col items-center p-6 bg-gray-50 min-h-screen">
        <h2 className="text-xl font-bold mb-4">
          Delete / Rearrange / Enlarge Pages
        </h2>

        {/* Upload */}
        <input
          type="file"
          style={{color: 'blue', fontSize: '16px', border: '2px solid black', marginRight: '5px'}}
        ...
        {/* PDF thumbnails */}
        <div style={{border: '2px solid black', marginTop: '15px', padding: '15px'}}>
        {file && (
